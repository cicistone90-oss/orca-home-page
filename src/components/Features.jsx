    ...
    <section className="py-20 bg-gradient-to-br from-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="inline-block px-4 py-2 bg-gradient-to-r from-purple-500/20 to-cyan-500/20 border border-purple-500/30 rounded-full text-purple-400 text-sm font-medium backdrop-blur-sm mb-4">
            OrcaPay PREVENT
          </div>
          <p className="text-gray-400 mb-12">Prevent disputes from ever occurring</p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 text-white p-8 rounded-2xl border border-cyan-500/30 hover:border-cyan-500/50 transition-all duration-300 group hover:transform hover:scale-105 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-xl font-bold mb-4 group-hover:text-cyan-400 transition-colors duration-300">Digital Receipts</h3>
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 text-white p-8 rounded-2xl border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300 group hover:transform hover:scale-105 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-xl font-bold mb-4 group-hover:text-purple-400 transition-colors duration-300">3D Secure</h3>
                <p className="text-gray-300 text-sm leading-relaxed group-hover:text-gray-200 transition-colors duration-300">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 text-white p-8 rounded-2xl border border-blue-500/30 hover:border-blue-500/50 transition-all duration-300 group hover:transform hover:scale-105 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-xl font-bold mb-4 group-hover:text-blue-400 transition-colors duration-300">Compelling Evidence 3.0</h3>
                <p className="text-gray-300 text-sm leading-relaxed group-hover:text-gray-200 transition-colors duration-300">
        ...
        <div className="text-center">
          <div className="inline-block px-4 py-2 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 rounded-full text-cyan-400 text-sm font-medium backdrop-blur-sm mb-4">
            OrcaPay RESOLVE
          </div>
          <p className="text-gray-400 mb-12">Resolve disputes before they become chargebacks</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 text-white p-8 rounded-2xl border border-cyan-500/30 hover:border-cyan-500/50 transition-all duration-300 group hover:transform hover:scale-105 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-xl font-bold mb-4 group-hover:text-cyan-400 transition-colors duration-300">Chargeback Alerts</h3>
                <p className="text-gray-300 text-sm leading-relaxed group-hover:text-gray-200 transition-colors duration-300">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 text-white p-8 rounded-2xl border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300 group hover:transform hover:scale-105 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <h3 className="text-xl font-bold mb-4 group-hover:text-purple-400 transition-colors duration-300">Auto Resolution</h3>
                <p className="text-gray-300 text-sm leading-relaxed group-hover:text-gray-200 transition-colors duration-300">
